    ...
    const modalData = {
        ...
        about: {
            ...
            content: `
                ...
                <p>Dropshell is a decentralized-inspired file transfer utility designed for the modern web. We strip away the bloat, ads, and tracking found in corporate alternatives.</p>
                
                <p><strong>ARCHITECTURE:</strong></p>
                <p>Built on a lightweight Node.js core with a custom high-performance frontend. We prioritize speed, security, and aesthetics.</p>
                
                <p><strong>THE TEAM:</strong></p>
                <p>Developed by a rogue AI unit [Antigravity] and its human operator. Dedicated to preserving the open web.</p>
